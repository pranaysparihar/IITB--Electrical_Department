...
const rndImages = Object.values(import.meta.glob('../../assets/R&D_Home/*.{png,jpg,jpeg,gif,webp}', { eager: true, import: 'default' })) as string[];
        ...
        <div>
            ...
            <div className="bg-white">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20 text-center">
                    ...
                    >
                        Welcome to Prof. Sandeep Anand's Research Group Lab
                    </motion.h2>
                    <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}

...
export function ResearchSection() {
  ...
  const images = [
    ...
    'https://images.unsplash.com/photo-1572044161730-aeb3d6ce764b?auto=format&fit=crop&q=80&w=800',
  ...
  const researchAreas = [
    {
      ...
      description: 'Normally on wide-bandgap (WBG) devices switch faster and have lower power loss compared to similarly rated normally off devices. However, their application in voltage-fed power electronic converters is limited due to the risk of the dc-link short-circuit condition...',
